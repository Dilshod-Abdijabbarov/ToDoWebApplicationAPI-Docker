...
RUN dotnet build "ToDoWebApplication.csproj" -c Release -o /app/build

FROM build AS publish
RUN dotnet publish "ToDoWebApplication.csproj" -c Release -o /app/publish /p:UseAppHost=false
